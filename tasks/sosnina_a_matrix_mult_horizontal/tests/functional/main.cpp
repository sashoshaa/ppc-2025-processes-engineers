...
const std::array<TestType, 22> kFunctionalTests = {
    ...
    std::make_tuple(4,
        std::vector<std::vector<double>>{{2, 0}, {0, 2}},
    ...
    // 13. Дробные числа
    std::make_tuple(13,
        std::vector<std::vector<double>>{{0.5, 0.5}, {0.5, 0.5}},
    ...
    std::make_tuple(18,
        std::vector<std::vector<double>>{{1, 1}, {1, 1}},
        std::vector<std::vector<double>>{{2, 2}, {2, 2}},
        std::vector<std::vector<double>>{{4, 4}, {4, 4}}),
    ...
    std::make_tuple(21,
        std::vector<std::vector<double>>{{2, 3}, {4, 5}},
        std::vector<std::vector<double>>{{1, 0}, {0, 1}},
        std::vector<std::vector<double>>{{2, 3}, {4, 5}}),
...
inline const auto kPerfTestName = SosninaAMatrixMultHorizontalFuncTests::PrintFuncTestName<SosninaAMatrixMultHorizontalFuncTests>;
