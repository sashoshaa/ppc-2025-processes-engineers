...
TEST(sosnina_a_diff_count_mpi, coverage_empty_strings) {
  ...
  bool empty_success =
      empty_task.Validation() && empty_task.PreProcessing() && empty_task.Run() && empty_task.PostProcessing();
...
TEST(sosnina_a_diff_count_mpi, coverage_different_lengths) {
  ...
  bool diff_len_success = diff_len_task.Validation() && diff_len_task.PreProcessing() && diff_len_task.Run() &&
                          diff_len_task.PostProcessing();
